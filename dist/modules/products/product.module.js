    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: product_variation_scheme_1.ProductVariation.name, schema: product_variation_scheme_1.ProductVariationSchema },
            ]),
            redis_module_1.RedisModule,
            cloudinary_module_1.CloudinaryModule,
        ],
        controllers: [product_controller_1.ProductController],
        providers: [product_service_1.ProductService, redis_service_1.RedisService, cloudinary_service_1.CloudinaryService],
