...
import { ProductModelDocument } from '../products/schemes/product-variation.scheme';
...
export declare class StocksService {
    ...
    constructor(redisService: RedisService, productVariationModel: Model<ProductModelDocument>);
