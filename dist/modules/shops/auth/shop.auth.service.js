...
exports.AuthShopService = void 0;
...
let AuthShopService = class AuthShopService {
    ...
    async register(data) {
        ...
        try {
            ...
            if (err instanceof typeorm_2.QueryFailedError && err.driverError.code === '23505') {
...
exports.AuthShopService = AuthShopService;
exports.AuthShopService = AuthShopService = __decorate([
