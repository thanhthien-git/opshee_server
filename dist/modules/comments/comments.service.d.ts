...
export declare class CommentsService {
    ...
    getCommentByProduct(productId: string, page?: number, limit?: number): Promise<{
        data: (import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("./shema/comment.schema").Comment> & import("./shema/comment.schema").Comment & Required<{
            _id: Types.ObjectId;
        }> & {
            __v: number;
        }> & import("mongoose").Document<unknown, {}, import("./shema/comment.schema").Comment> & import("./shema/comment.schema").Comment & Required<{
            _id: Types.ObjectId;
        }> & {
            __v: number;
        })[];
